...
const NUM_BOXES = 50;
//stateless func
// ({color}) is destruct because you can choose what props to take out of the props obj by destruct
const Box = ({color}) => {
  const style = {
    width: '180px',
    height: '180px',
...
class App extends Component {
  ...
  constructor(props) {
    super(props);
    // create array of 32, fill with the map of getRandonColor, keep state as app by using 2nd map param(what you want the key word this to be)
